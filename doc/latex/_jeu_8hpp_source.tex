...
00060         
00061         \hyperlink{class_joueur}{Joueur}* \hyperlink{class_jeu_a676f11e6bda0cde27f128e90cbaae765}{getJoueurCourant}();
00062         \hyperlink{class_joueur}{Joueur}* \hyperlink{class_jeu_aeaa0f199d6a1c9271a49b226159dd1ca}{getJoueurAutre}();
00063         \hyperlink{class_etat}{Etat}* \hyperlink{class_jeu_a6a84bec16f8075c1c9b867096dfc2b06}{getEtatCourant}();
00064         \hyperlink{class_etat}{Etat}* \hyperlink{class_jeu_a6af6b2d0bd215cde1d63dbe3e799b291}{getEtatNoMana}();
00065         \hyperlink{class_etat}{Etat}* \hyperlink{class_jeu_a4935a721a0e230cebae3905c78f3721f}{getEtatNoAttaque}();
00066         \hyperlink{class_etat}{Etat}* \hyperlink{class_jeu_a94fc4b05a1d532795b4c8a5d0fec4003}{getEtatDoubleNo}();
00067         \hyperlink{class_etat}{Etat}* \hyperlink{class_jeu_a8ae205a6a9d95ec5bed20e2fdf5c74a7}{getEtatDebutTour}();
00068         \hyperlink{class_vue_console}{VueConsole} \hyperlink{class_jeu_a6a98e2284176a68e9096a331d7da75e7}{getVue}();
00069         
00070         \textcolor{keywordtype}{void} \hyperlink{class_jeu_a86087ecade936bff6bad82eb024ba6bf}{attaqueCvC}(\textcolor{keywordtype}{int} index1, \textcolor{keywordtype}{int} index2);
00071         \textcolor{keywordtype}{void} \hyperlink{class_jeu_a81b8b7bc79f9df1b1f3c557e04e8c634}{attaqueCvJ}(\textcolor{keywordtype}{int} index);
00072         \textcolor{keywordtype}{void} \hyperlink{class_jeu_a43c11cf6d659b78dd957cfa65d6d5547}{enleverMalinvoc}();
00073         \textcolor{keywordtype}{bool} \hyperlink{class_jeu_abbbc59a98fe8296456ddc112faa2b66b}{testNoMana}();
00074         \textcolor{keywordtype}{bool} \hyperlink{class_jeu_a391aae052833ebc367a660f4d3a7df29}{testProvoc}();
00075         \textcolor{keywordtype}{bool} \hyperlink{class_jeu_a2613ca19004343323262ca2b0d55ca33}{testNoAttaque}();
00076         \textcolor{keywordtype}{void} \hyperlink{class_jeu_a2952107f355b2d0c53bfc2a048c17705}{echangeJoueur}(); \textcolor{comment}{// echange les deux joueurs dans joueurCourant et joueurAutre}
00077         \textcolor{keywordtype}{void} \hyperlink{class_jeu_a0e5e13b72cd123ac0afef1fa001c9d5f}{setEtat}(\hyperlink{class_etat}{Etat}* e); \textcolor{comment}{//setEtat}
00078         \textcolor{keywordtype}{void} \hyperlink{class_jeu_a042628965e72acf7d4d498aa88f32f1f}{finTour}(); 
00079         \textcolor{keywordtype}{void} \hyperlink{class_jeu_a23aa7effc82b36e177013394ee74421e}{jouer}();\textcolor{comment}{// lance le tour}
00080         \textcolor{keywordtype}{void} \hyperlink{class_jeu_a88bf8ed9150f780b02e70decc60a3f02}{enregistrerObs}(\hyperlink{class_observer}{Observer}* O);
00081         \textcolor{keywordtype}{void} \hyperlink{class_jeu_a8a051ac409a0e53397df3d4578a1e571}{supprimerObs}(\hyperlink{class_observer}{Observer}* O);
00082         \textcolor{keywordtype}{void} \hyperlink{class_jeu_ad955ffee4ed18add167fa957386a9821}{notifierObs}();
00083         \textcolor{keywordtype}{void} \hyperlink{class_jeu_a97de7b353912bf1754c33c41ea753790}{fonctionsCarte}(\textcolor{keywordtype}{int} f);
00084         
00085         
00086         
00087         
...
00089 
00090 
00091 \textcolor{preprocessor}{#include "\hyperlink{_etat_8hpp}{Etat.hpp}"}
00092 \textcolor{preprocessor}{#include "\hyperlink{_etat_debut_tour_8hpp}{EtatDebutTour.hpp}"}
00093 \textcolor{preprocessor}{#include "\hyperlink{_etat_no_mana_8hpp}{EtatNoMana.hpp}"}
00094 \textcolor{preprocessor}{#include "\hyperlink{_etat_no_attaque_8hpp}{EtatNoAttaque.hpp}"}
00095 \textcolor{preprocessor}{#include "\hyperlink{_etat_double_no_8hpp}{EtatDoubleNo.hpp}"}
00096 \textcolor{preprocessor}{#include "../../src/Controleur/Jeu.cpp"}
00097 \textcolor{preprocessor}{#endif // JEU\_HPP       }
\end{DoxyCode}
